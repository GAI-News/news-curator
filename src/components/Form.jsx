  ...
  return (
    <div className="w-full h-screen max-h-screen bg-slate-800 text-gray-300 flex flex-col justify-between">
      <div className="bg-slate-800 mt-16">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col justify-center m-auto w-[25%] min-w-[300px] mt-[100px]">
      ...
      <div className="p-[30px] bg-slate-900 w-full flex justify-around items-center">
        {/* left Footer */}
        ...
        {/* right Footer */}
        <div>
          <p className="text-[18px]">Made by Beks, Jeremy, Alex, Smiks and William</p>
        </div>
      </div>
    </div>
  )
